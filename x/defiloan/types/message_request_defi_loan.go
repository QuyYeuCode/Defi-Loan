...
const TypeMsgRequestDefiLoan = "request_defi_loan"

var _ sdk.Msg = &MsgRequestDefiLoan{}

func NewMsgRequestDefiLoan(creator string, amount string, fee string, collateral string, deadline string) *MsgRequestDefiLoan {
	return &MsgRequestDefiLoan{
		Creator:    creator,
		Amount:     amount,
		Fee:        fee,
...
func (msg *MsgRequestDefiLoan) Route() string {
	return RouterKey
}

func (msg *MsgRequestDefiLoan) Type() string {
	return TypeMsgRequestDefiLoan
}

func (msg *MsgRequestDefiLoan) GetSigners() []sdk.AccAddress {
...
func (msg *MsgRequestDefiLoan) GetSignBytes() []byte {
	bz := ModuleCdc.MustMarshalJSON(msg)
	return sdk.MustSortJSON(bz)
}

func (msg *MsgRequestDefiLoan) ValidateBasic() error {
