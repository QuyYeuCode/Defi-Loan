...
import QuyYeuCodeDefiLoanQuyYeuCodeDefiloanDefiloan from './QuyYeuCode/Defi-Loan/QuyYeuCode.defiloan.defiloan'
...
export default { 
  QuyYeuCodeDefiLoanQuyYeuCodeDefiloanDefiloan: load(QuyYeuCodeDefiLoanQuyYeuCodeDefiloanDefiloan, 'QuyYeuCode.defiloan.defiloan'),
